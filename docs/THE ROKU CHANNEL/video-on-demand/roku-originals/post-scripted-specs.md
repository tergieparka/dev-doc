---
title: Scripted media delivery specifications
excerpt: ''
deprecated: false
hidden: false
metadata:
...
- Short Form episodes with a total run time of 11-15 minutes will be required to include 1 ad break in each episode.
  - Short Form episodes with a total run time of less than 11 minutes will not need to include any act breaks
  - The first ad break should not appear until at least 6 minutes of content have elapsed
...
- Eps. 1-3 cuts must be turnaround within 5 business days of receiving notes from Roku
- Eps. 4+ cuts must all be turned around within 3 business days of receiving notes from Roku
...
Roku Production will provide a recipient list for all rough cuts prior to the scheduled release of the first episode. The [Frame.io](http://frame.io/) team will walk each project through Roku’s preferred rough cut release workflow, which involves:
...
Roku prefers to receive both the un-graded and graded high-resolution master sequences as part of final delivery for wholly-owned. These files should be exported in DPX or TIFF, at the highest bitrate possible (16-bit preferred). Please package DPX or TIFF image sequence folders into a single .zip file for delivery.
...
As each production will differ with regards to promotional assets, please reach out to determine the specific asks for your show.
...
- ‘Roku Presents’, followed by a subsequent card reading ‘A Roku Original’ or ‘A Roku Original Series’ (Please confirm with Roku Post).
...
| Resolution            | UHD (scripted) + Color Space = SDR or HDR                                                               |
...
| ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| Container              | MOV                                                                                                                                           |
| Profile                | 4444XQ (4444 okay if exporting from Premiere)<br /><br />Scripted : 4444 XQ (4444 Ok if exporting from Premiere) if source is 4:4:4; or 422 H |
| Minimum Bitrate        | 50 mbit/s or higher                                                                                                                           |
| Landscape aspect ratio | 16:9 (1.77:1) - (no black bars)<br />Scripted Series: W3840 x H2160 (UHD)                                                                     |
...
| Track Layout                       | <u>Interleaved</u>: Track 1: 5.1, L-R-C-LFE-Ls-Rs  Track 2: Stereo, LT/RT<br /><u>Mono</u>:   5.1, L, R, C, LFE, Ls, Rs, Stereo LT, Stereo RT<br />**7.1 audio is not permitted on any masters at this time** |
...
Additionally, if foreign language subtitles cover 30% or more of a given episode, you will be <u>required</u> to deliver a fully textless version of that episode. All episodes should be delivered with the same formatting; if one episode requires a textless master, versus a reel, then all remaining episodes should also be delivered as textless masters.
...
- VAMs – Un-color-corrected, textless, DPX or TIFF format (\***_Compress\*_** to .ZIP or .TAR)
  - Associated Avid bins or EDLs
- CTM – Color-corrected, textless, DPX or TIFF format (\***_Compress\*_** to .ZIP or .TAR)
...
- 3.4 - Sizzle requirements added for Roku’s main title presentation cards and deliverables.
...
- 6.1.4 - Live, remote mix playback policy for Roku Creative and Post Production.
...
- 9.1 - Final Archival Media will now be uploaded to AWS S3, rather than Frame.io and for LTO Archive please use LTO10.
